  ...
  const handleSubmit = async event => {
    ...
    try {
      const response = await axios
        .post('https://backend-ymqh.onrender.com/api/events/create', formData, {
          headers: {
      ...
      console.log(
        'There is an error when try to send POST REQUEST to https://backend-ymqh.onrender.com/api/events/create',
      );
