  ...
  const handleUpdate = async event => {
    ...
    try {
      const response = await axios
        .put(
          `https://backend-ymqh.onrender.com/api/events/modify/${eventInformation._id}`,
          formData,
          {
            headers: {
      ...
      console.log(
        'There is an error when try to send PUT REQUEST to https://backend-ymqh.onrender.com/api/events/modify/:id',
      );
